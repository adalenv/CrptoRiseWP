                            ...
                            <?php
                                if(ae_get_option('poll_maker') !=="0"){
                                    ...
                                    <li class="<?php if (isset($_GET['type']) && $_GET['type'] == "poll") echo 'active'; ?>">
                                        <a href="<?php echo esc_url(add_query_arg(array('type' => 'poll', 'paged' => 1))); ?>"><?php _e('Polls', ET_DOMAIN) ?></a>
                                    </li>
                                    <?php
                                }
                            ?>
                            <li class="<?php if(isset($_GET['type']) && $_GET['type'] == "answer") echo 'active'; ?>" >
                                <a href="<?php echo esc_url(add_query_arg(array('type'=>'answer', 'paged' => 1))); ?>"><?php _e('Answers',ET_DOMAIN) ?></a>
                            </li>
                            <?php if($current_user->ID == $user->ID){ ?>
