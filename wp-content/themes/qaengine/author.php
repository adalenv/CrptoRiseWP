                ...
                <ul>
                        ...
                        if(ae_get_option('poll_maker') !=="0"){
                            ...
                            <li>
                                <a class="<?php if (isset($_GET['type']) && $_GET['type'] == "poll") echo 'active'; ?>"
                                   href="<?php echo esc_url(add_query_arg(array('type' => 'poll', 'paged' => 1))); ?>"><?php _e('Polls', ET_DOMAIN) ?></a>
                            </li>
                            <?php
                        }
                    ?>
                    <li>
                        <a class="<?php if (isset($_GET['type']) && $_GET['type'] == "answer") echo 'active'; ?>"
                           href="<?php echo esc_url(add_query_arg(array('type' => 'answer', 'paged' => 1))); ?>"><?php _e('Answers', ET_DOMAIN) ?></a>
                    </li>
                    <?php if ($current_user->ID == $user->ID) { ?>
                        <li>
