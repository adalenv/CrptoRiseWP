...
function crtools_graph_shortcode( $atts ) {
    ...
    $params = array(
        ...
        'graphColor' => isset($atts['graphColor']) ? $atts['graphColor'] : '',
        'cursorColor' => isset($atts['cursorColor']) ? $atts['cursorColor'] : '',
    );
...
function crtools_iclude_scripts( $type ) {
    ...
    switch($type)
    {
        ...
        case 'graph':
            ...
            wp_enqueue_script( 'amcharts-main', CRTOOLS_URL.'assets/js/libs/amcharts/amcharts.js');
            wp_enqueue_script( 'amcharts-serial', CRTOOLS_URL.'assets/js/libs/amcharts/serial.js');
            wp_enqueue_script( 'amcharts-light', CRTOOLS_URL.'assets/js/libs/amcharts/light.js');
            wp_enqueue_script( 'amcharts-responsive', CRTOOLS_URL.'assets/js/libs/amcharts/responsive.min.js');
            wp_enqueue_script( 'amcharts-amstock', CRTOOLS_URL.'assets/js/libs/amcharts/amstock.js');
...
function crtools_get_custom_css(){
    ...
    if (get_option('crtools-css') and get_option('crtools-css')!=''){

        echo '

      <style type="text/css">

        '.esc_html(get_option('crtools-css')).'
